...
export default function TIMEBEUNUSPage() {
  ...
  const [ownerPanelTab, setOwnerPanelTab] = useState<'trade' | 'positions' | 'automation' | 'yield' | 'suggestions' | 'ai-bots'>('trade');
      ...
      <div className="card p-5 border-2 border-yellow-500/30 bg-gradient-to-br from-yellow-900/10 to-orange-900/10">
        ...
        <div className="flex gap-2 mb-4 border-b border-slate-700 pb-2 overflow-x-auto">
          {[
            ...
            { id: 'ai-bots', label: 'AI Power Bots', icon: Brain },
          ].map(tab => (
            <button
              key={tab.id}
        ...
        <div className="min-h-[300px]">
          ...
          {/* AI Power Bots Tab - ADMIN GETS FREE ACCESS */}
          {ownerPanelTab === 'ai-bots' && (
            <div className="space-y-4">
              ...
              <div className="p-4 bg-gradient-to-r from-yellow-500/20 to-orange-500/20 border border-yellow-500/30 rounded-xl">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-bold text-yellow-400">TIMEBEUNUS ADMIN - FREE ACCESS</h4>
                    <p className="text-sm text-yellow-300/80">All AI bots below are 100% FREE for you. Users pay 15-25% of profits.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-6">
                <h4 className="text-lg font-semibold text-purple-400 mb-3 flex items-center gap-2">
                  <Brain className="w-5 h-5" />Investment AI Bots
                  <span className="text-xs px-2 py-0.5 rounded-full bg-purple-500/20 text-purple-400">4 BOTS</span>
                </h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  ...
                  <div className="p-4 bg-slate-800/50 rounded-lg border border-blue-500/30">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div>
                        <h5 className="font-bold text-white">Whale Shadow Bot</h5>
                        <span className="text-xs text-slate-500 font-mono">WHALE_TRACKER</span>
                      </div>
                    </div>
                    <p className="text-xs text-slate-400 mb-2">Tracks whale wallet movements, positions you BEFORE major price moves.</p>
                    <div className="flex items-center justify-between">
                      <span className="text-emerald-400 font-bold">+47.2% APY</span>
                      <span className="text-xs px-2 py-1 bg-green-500/20 text-green-400 rounded">FREE FOR YOU</span>
                    </div>
                  </div>
                  ...
                  <div className="p-4 bg-slate-800/50 rounded-lg border border-purple-500/30">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div>
                        <h5 className="font-bold text-white">Sentiment Pulse Bot</h5>
                        <span className="text-xs text-slate-500 font-mono">AI_SENTIMENT</span>
                      </div>
                    </div>
                    <p className="text-xs text-slate-400 mb-2">GPT-4 scans news & social media. Buys fear, sells greed.</p>
                    <div className="flex items-center justify-between">
                      <span className="text-emerald-400 font-bold">+38.5% APY</span>
                      <span className="text-xs px-2 py-1 bg-green-500/20 text-green-400 rounded">FREE FOR YOU</span>
                    </div>
                  </div>
                  ...
                  <div className="p-4 bg-slate-800/50 rounded-lg border border-emerald-500/30">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div>
                        <h5 className="font-bold text-white">Smart DCA Bot</h5>
                        <span className="text-xs text-slate-500 font-mono">AI_DCA</span>
                      </div>
                    </div>
                    <p className="text-xs text-slate-400 mb-2">AI determines OPTIMAL buy times. Buys more when fear is high.</p>
                    <div className="flex items-center justify-between">
                      <span className="text-emerald-400 font-bold">+29.8% APY</span>
                      <span className="text-xs px-2 py-1 bg-green-500/20 text-green-400 rounded">FREE FOR YOU</span>
                    </div>
                  </div>
                  ...
                  <div className="p-4 bg-slate-800/50 rounded-lg border border-green-500/30">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div>
                        <h5 className="font-bold text-white">Tax Harvester Bot</h5>
                        <span className="text-xs text-slate-500 font-mono">TAX_OPTIMIZER</span>
                      </div>
                    </div>
                    <p className="text-xs text-slate-400 mb-2">Auto tax-loss harvesting. Sells losers, reinvests immediately.</p>
                    <div className="flex items-center justify-between">
              ...
              <div>
                <h4 className="text-lg font-semibold text-pink-400 mb-3 flex items-center gap-2">
                  <Users className="w-5 h-5" />Social Intelligence Bots
                  <span className="text-xs px-2 py-0.5 rounded-full bg-pink-500/20 text-pink-400">4 BOTS</span>
                </h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {/* Strategy DNA Matching */}
                  <div className="p-4 bg-slate-800/50 rounded-lg border border-pink-500/30">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div>
                        <h5 className="font-bold text-white">Strategy DNA Matching</h5>
                        <span className="text-xs text-slate-500 font-mono">DNA_MATCH</span>
                      </div>
                    </div>
                    <p className="text-xs text-slate-400 mb-2">AI matches your trading DNA with compatible traders for better copy results.</p>
                    <div className="flex items-center justify-between">
                      <span className="text-emerald-400 font-bold">89% Accuracy</span>
                      <span className="text-xs px-2 py-1 bg-green-500/20 text-green-400 rounded">FREE FOR YOU</span>
                    </div>
                  </div>

                  {/* Collective Intelligence Bot */}
                  <div className="p-4 bg-slate-800/50 rounded-lg border border-purple-500/30">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div>
                        <h5 className="font-bold text-white">Collective Intelligence</h5>
                        <span className="text-xs text-slate-500 font-mono">HIVE_MIND</span>
                      </div>
                    </div>
                    <p className="text-xs text-slate-400 mb-2">Aggregates signals from TOP 100 traders. Alerts when consensus forms.</p>
                    <div className="flex items-center justify-between">
                      <span className="text-emerald-400 font-bold">76% Accuracy</span>
                      <span className="text-xs px-2 py-1 bg-green-500/20 text-green-400 rounded">FREE FOR YOU</span>
                    </div>
                  </div>
                  ...
                  <div className="p-4 bg-slate-800/50 rounded-lg border border-amber-500/30">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div>
                        <h5 className="font-bold text-white">AI Confidence Scoring</h5>
                        <span className="text-xs text-slate-500 font-mono">TRUST_SCORE</span>
                      </div>
                    </div>
                    <p className="text-xs text-slate-400 mb-2">AI scores every trader's reliability. Predicts future performance.</p>
                    <div className="flex items-center justify-between">
                      <span className="text-emerald-400 font-bold">82% Accuracy</span>
                      <span className="text-xs px-2 py-1 bg-green-500/20 text-green-400 rounded">FREE FOR YOU</span>
                    </div>
                  </div>
                  ...
                  <div className="p-4 bg-slate-800/50 rounded-lg border border-teal-500/30">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div>
                        <h5 className="font-bold text-white">Risk-Adjusted Copying</h5>
                        <span className="text-xs text-slate-500 font-mono">SMART_COPY</span>
                      </div>
                    </div>
                    <p className="text-xs text-slate-400 mb-2">AI adjusts copy ratios in real-time. More on streaks, less in volatility.</p>
                    <div className="flex items-center justify-between">
                      <span className="text-emerald-400 font-bold">+41.8% Avg Return</span>
                      <span className="text-xs px-2 py-1 bg-green-500/20 text-green-400 rounded">FREE FOR YOU</span>
                    </div>
                  </div>
                </div>
              ...
              {/* User Fee Structure Info */}
              <div className="p-4 bg-slate-800/50 rounded-lg border border-slate-700">
                <h4 className="font-semibold text-white mb-2 flex items-center gap-2">
                  <Percent className="w-4 h-4 text-cyan-400" />User Fee Structure (For Non-Admin Users)
                </h4>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-center">
                  <div className="p-2 bg-slate-700/50 rounded">
                    <p className="text-lg font-bold text-purple-400">15-25%</p>
                    <p className="text-xs text-slate-400">Of Profits Only</p>
                  </div>
                  <div className="p-2 bg-slate-700/50 rounded">
                    <p className="text-lg font-bold text-green-400">$0</p>
                    <p className="text-xs text-slate-400">Upfront Cost</p>
                  </div>
                  <div className="p-2 bg-slate-700/50 rounded">
                    <p className="text-lg font-bold text-cyan-400">$0</p>
                    <p className="text-xs text-slate-400">Losing Trade Fee</p>
                  </div>
                  <div className="p-2 bg-slate-700/50 rounded">
                    <p className="text-lg font-bold text-yellow-400">0%</p>
                    <p className="text-xs text-slate-400">YOUR Fee (Admin)</p>
                  </div>
                </div>
              </div>
            </div>
