  ...
  try {
    const quickActions = [
      ...
      },
      {
        ...
        description: 'AutoPilot add-on (+$39/mo)',
      ...
      },
      {
        ...
        description: 'Premium add-on (+$59/mo)',
      ...
      },
      {
        ...
        action: 'How do I manage my subscription and billing?',
        category: 'billing',
      },
      {
        id: 'human-support',
        ...
        action: 'I would like to speak to a human support agent',
        category: 'escalation',
      },
    ];
